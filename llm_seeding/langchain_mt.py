...
def _build_example(good_inds: list):
    example = ""
    ...
    prompt = ChatPromptTemplate.from_messages(
        [
            ...
            (
                ...
                "This individual contains two heuristics: 'vm' and 'pm'.\n"
                "Primitive sets:\n"
                ...
                "Example good individuals: {good_individuals}\n"
                "Task:\n"
                "Analyse the pattern of given individual along with the example good individuals. Then, "
                "refine slightly the given individual to generate one new individuals aiming to improve the performance. "
...
def get_llm_mutation(
    ...
    *,
    ...
    formatted_prompt = prompt.format_prompt(vm_terminals=VM_TERMINALS,
                                            ...
                                            good_individuals=_build_example(good_inds))
